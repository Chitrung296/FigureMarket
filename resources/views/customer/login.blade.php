...
<link rel='stylesheet' href='https://fonts.googleapis.com/css?family=Roboto:100,300,400,500,700,900|Material+Icons'><link rel="stylesheet" href="../custommer/login/style.css">
...
<div class="form">
  ...
  <div class="form-panel one">
    ...
    <div class="form-content">
      <form action="{{url('customer/loginProcess')}}" method="POST">
        @csrf
        {{-- @if (Session::has('fail'))
...
<script src='https://codepen.io/andytran/pen/vLmRVp.js'></script><script  src="../custommer/login/script.js"></script>
