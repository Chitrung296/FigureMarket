                    ...
                    <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col logo_section">
                        <div class="full">
                            <div class="center-desk">
                                <div class="logo">
                                    <a href="{{ url('customer/index1') }}"><img
                                            src="../custommer/images/logofmproject.png"
                                            style="height:120px; width:120px; " alt="#" /></a>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <ul class="navbar-nav mr-auto">
                                    ...
                                    @if (Session::has('cusEmail') && Session::has('cusId'))
                                        <li class="nav-item d_none login_btn">
                                            <a class="nav-link"
                                                href="{{ route('customer.edit', ['id' => Session::get('cusId')]) }}">Hello:
                                                {{ Session::get('cusName') }}</a>
                                        </li>
                    ...
                    <div class="container">
                        <div class="carousel-caption">
                            <div class="text-bg">
                                ...
                                <figure><img src="../custommer/images/homepagefmproject2.png" alt="#" />
                                </figure>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-10 offset-md-1">
                    <div class="titlepage">
                        <h2>Our Figures</h2>
                        <p> AnimeMart is an online sales website specializing in products related to anime and otaku
                            culture. The site offers a wide range of anime's models.
            ...
            <div class="row">
                @foreach ($pro as $p)
                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6">
                        <div class="glasses_box" style=" padding: 0px 0px 0px 0px;">
                            <a href="{{ url('product-details') }}\{{ $p->productID }}"
                                title="Click this product to view details">
                                <figure><img src="../pro_img/{{ $p->productImage }}" alt="#" /></figure>
                            </a>
                            <h3>
                                <p>{{ $p->productName }}
                                <p><b>Price:{{ $p->productPrice }}$</b>
                            </h3>
